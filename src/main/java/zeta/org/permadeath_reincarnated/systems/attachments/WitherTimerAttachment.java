...
public class WitherTimerAttachment implements INBTSerializable<CompoundTag> {
   private static final int MAX_SECONDS = 3602;
   private int remainingTicks = 0;
   private int oldRemainingTicks = 0;

   public boolean isWitherTimerOn() {
      return this.remainingTicks > 0;
   }

   public void reset() {
      this.remainingTicks = 0;
      this.oldRemainingTicks = 0;
   }

   public void startWitherTimer() {
      this.remainingTicks = 3602;
   }
