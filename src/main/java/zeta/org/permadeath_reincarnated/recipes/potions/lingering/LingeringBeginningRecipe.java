...
public class LingeringBeginningRecipe extends CustomRecipe {
   ...
   public LingeringBeginningRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         ...
         Component.translatable("item.permadeath_reincarnated.lingering_potion_beginning").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.LINGERING_BEGINNING.get();
   }
