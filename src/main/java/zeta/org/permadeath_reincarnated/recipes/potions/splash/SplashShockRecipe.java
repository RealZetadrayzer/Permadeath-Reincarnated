...
public class SplashShockRecipe extends CustomRecipe {
   ...
   public SplashShockRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         DataComponents.CUSTOM_NAME, Component.translatable("item.permadeath_reincarnated.splash_potion_shock").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.SPLASH_SHOCK.get();
   }
   ...
   private static boolean isPermadeathPotion(ItemStack stack) {
      ...
      return tag.getInt("permadeath_shock") == 1;
   }
