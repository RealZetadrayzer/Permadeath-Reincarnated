package zeta.org.permadeath_reincarnated.recipes.potions.splash;
...
public class SplashBeginningRecipe extends CustomRecipe {
   ...
   public SplashBeginningRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         DataComponents.CUSTOM_NAME, Component.translatable("item.permadeath_reincarnated.splash_potion_beginning").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.SPLASH_BEGINNING.get();
   }
   ...
   private static boolean isPermadeathPotion(ItemStack stack) {
      ...
      return tag.getInt("permadeath_beginning") == 1;
   }
