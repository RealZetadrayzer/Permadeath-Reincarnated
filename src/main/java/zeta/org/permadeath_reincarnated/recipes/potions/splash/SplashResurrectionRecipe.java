...
public class SplashResurrectionRecipe extends CustomRecipe {
   ...
   public SplashResurrectionRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         ...
         Component.translatable("item.permadeath_reincarnated.splash_potion_resurrection").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.SPLASH_RESURRECTION.get();
   }
   ...
   private static boolean isPermadeathPotion(ItemStack stack) {
      ...
      return tag.getInt("permadeath_resurrection") == 1;
   }
