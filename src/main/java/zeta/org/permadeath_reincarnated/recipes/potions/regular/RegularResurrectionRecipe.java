...
public class RegularResurrectionRecipe extends CustomRecipe {
   public static final int[] COUNTS = new int[]{4, 1, 4, 1, 4, 1, 4, 1, 4};
   ...
   public RegularResurrectionRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         DataComponents.CUSTOM_NAME, Component.translatable("item.permadeath_reincarnated.potion_resurrection").withStyle(style -> style.withItalic(false))
      );
      PotionContents contents = new PotionContents(
         Optional.empty(),
         Optional.of(2563101),
         List.of(
            new MobEffectInstance(MobEffects.DAMAGE_RESISTANCE, 60, 4),
      ...
      tag.putInt("permadeath_resurrection", 1);
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.REGULAR_RESURRECTION.get();
   }
