...
public class LingeringWitherRageRecipe extends CustomRecipe {
   ...
   public LingeringWitherRageRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         ...
         Component.translatable("item.permadeath_reincarnated.lingering_potion_wither_rage").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.LINGERING_WITHER_RAGE.get();
   }
