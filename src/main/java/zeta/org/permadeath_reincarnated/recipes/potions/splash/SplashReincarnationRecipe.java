...
public class SplashReincarnationRecipe extends CustomRecipe {
   ...
   public SplashReincarnationRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         ...
         Component.translatable("item.permadeath_reincarnated.splash_potion_reincarnation").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.SPLASH_REINCARNATION.get();
   }
