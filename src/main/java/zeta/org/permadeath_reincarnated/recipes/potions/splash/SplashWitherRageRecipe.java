...
public class SplashWitherRageRecipe extends CustomRecipe {
   ...
   public SplashWitherRageRecipe(CraftingBookCategory category) {
      super(category);
   }
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      ...
      result.set(
         ...
         Component.translatable("item.permadeath_reincarnated.splash_potion_wither_rage").withStyle(style -> style.withItalic(false))
      );
      result.setCount(1);
      return result;
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.SPLASH_WITHER_RAGE.get();
   }
   ...
   private static boolean isPermadeathPotion(ItemStack stack) {
      ...
      return tag.getInt("permadeath_wither_rage") == 1;
   }
