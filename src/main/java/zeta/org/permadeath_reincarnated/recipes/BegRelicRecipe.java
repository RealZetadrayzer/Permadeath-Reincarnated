...
public class BegRelicRecipe extends CustomRecipe {
   public static final int[] COUNTS = new int[]{4, 64, 4, 64, 1, 64, 4, 64, 4};
   ...
   public BegRelicRecipe(CraftingBookCategory category) {
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.BEG_RELIC.get();
   }
