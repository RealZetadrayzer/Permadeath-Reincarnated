...
public class NetheriteUpgradeTemplateDupeRecipe extends CustomRecipe {
   ...
   public NetheriteUpgradeTemplateDupeRecipe(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.CUSTOM_NETHERITE_UPGRADE_TEMPLATE.get(), 2);
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.NETHERITE_UPGRADE_DUPE.get();
   }
