...
public class BegRelicOriginalRecipe extends CustomRecipe {
   public static final int[] COUNTS = new int[]{1, 32, 1, 32, 1, 32, 1, 32, 1};
   private static final Item[] ITEMS = new Item[]{
      Items.SHULKER_SHELL,
      Items.DIAMOND_BLOCK,
      Items.SHULKER_SHELL,
      Items.DIAMOND_BLOCK,
      (Item)PermadeathItemsRegistry.PERMA_END_RELIC.get(),
      Items.DIAMOND_BLOCK,
      Items.SHULKER_SHELL,
      Items.DIAMOND_BLOCK,
      Items.SHULKER_SHELL
   ...
   public BegRelicOriginalRecipe(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.PERMA_BEG_RELIC.get());
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.BEG_RELIC_ORIGINAL.get();
   }
