...
public class InfernalNetheriteBoots extends CustomRecipe {
   ...
   public InfernalNetheriteBoots(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.PERMA_INFERNAL_NETHERITE_BOOTS.get());
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.INFERNAL_NETHERITE_BOOTS.get();
   }
}
