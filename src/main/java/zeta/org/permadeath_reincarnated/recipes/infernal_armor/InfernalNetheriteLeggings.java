...
public class InfernalNetheriteLeggings extends CustomRecipe {
   ...
   public InfernalNetheriteLeggings(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.PERMA_INFERNAL_NETHERITE_LEGGINGS.get());
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.INFERNAL_NETHERITE_LEGGINGS.get();
   }
}
