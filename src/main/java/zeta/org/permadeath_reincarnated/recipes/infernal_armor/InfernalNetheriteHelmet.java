...
public class InfernalNetheriteHelmet extends CustomRecipe {
   ...
   public InfernalNetheriteHelmet(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.PERMA_INFERNAL_NETHERITE_HELMET.get());
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.INFERNAL_NETHERITE_HELMET.get();
   }
}
