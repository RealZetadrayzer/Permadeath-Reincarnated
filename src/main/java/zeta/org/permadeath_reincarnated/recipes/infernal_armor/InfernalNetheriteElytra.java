...
public class InfernalNetheriteElytra extends CustomRecipe {
   ...
   public InfernalNetheriteElytra(CraftingBookCategory category) {
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.INFERNAL_NETHERITE_ELYTRA.get();
   }
}
