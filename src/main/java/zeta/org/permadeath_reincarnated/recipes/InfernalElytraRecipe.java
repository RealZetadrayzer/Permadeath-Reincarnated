...
public class InfernalElytraRecipe extends CustomRecipe {
   public static final int[] COUNTS = new int[]{4, 1, 4, 1, 1, 1, 4, 1, 4};
   ...
   public InfernalElytraRecipe(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.PERMA_INFERNAL_ELYTRA.get());
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.INFERNAL_ELYTRA.get();
   }
