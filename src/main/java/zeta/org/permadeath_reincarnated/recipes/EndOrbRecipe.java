...
public class EndOrbRecipe extends CustomRecipe {
   public static final int[] COUNTS = new int[]{1, 1, 1, 1, 1, 1, 1, 1, 1};
   private static final Item[] ITEMS = new Item[]{
      Items.NETHERITE_INGOT,
      (Item)PermadeathItemsRegistry.PERMA_IMMORTALITY_ESSENCE.get(),
      Items.NETHERITE_INGOT,
   ...
   public EndOrbRecipe(CraftingBookCategory category) {
   ...
   public ItemStack assemble(CraftingInput inv, Provider provider) {
      return new ItemStack((ItemLike)PermadeathItemsRegistry.PERMA_END_ORB.get());
   }
   ...
   public RecipeSerializer<?> getSerializer() {
      return (RecipeSerializer<?>)PermadeathRecipeSerializers.END_ORB.get();
   }
